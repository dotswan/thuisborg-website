				...
				<div class="questions">
					<div class="question-set">
						...
						<div class="step-footer">
							<div class="btns">
								<span @click="changeStepTo(3)"
								      class="secondary-btn">{{ Translate('reserve call', currentLang) }}</span>
								<span @click="changeStepTo(2)" class="green-btn">{{
										Translate('extend', currentLang)
								                                                 }}</span>
							</div>
						</div>
					</div>
					<div class="question-set">
						...
						<div class="question">
							...
							<div class="field w-80">
								<input type="number" v-model="inputs.q7"
								       :placeholder="Translate('Land Area (in sqm)', currentLang)">
							</div>
						</div>
						<div class="question">
							<div class="question-container">
						...
						<div class="question">
							<div class="question-container">
								<label>
									<b class="number">9.</b>
									<span>{{
											Translate('Would you consider to sublet part of your house?', currentLang)
									      }}</span>
								</label>
							</div>
							<div class="field w-80">
						...
						<div class="question">
							<div class="question-container">
								<label>
									<b class="number">10.</b>
									<span>{{
											Translate('How much would you like to receive every month from Thuisborg?', currentLang)
									      }}</span>
								</label>
							</div>
							<div class="field w-80">
						...
						<div class="step-footer">
							<div class="btns">
								<span @click="changeStepTo(1)"
								      class="secondary-btn">{{ Translate('previous step', currentLang) }}</span>
								<span class="green-btn">
									{{ Translate('reserve call', currentLang) }}</span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="results">
				<div class="result-wrapper" v-show="!extended">
					...
					<div class="resline">
						...
						<span class="green-link" @click="showDetails(1)">{{
								Translate('see details', currentLang)
						                                                 }}</span>
					</div>
				...
				<div class="result-wrapper" v-show="extended">
					...
					<div class="resline">
						<p class="label-question">{{ Translate('Would you like to know more?', currentLang) }}</p>
						<span class="green-link" @click="showDetails(2)">{{
								Translate('see details', currentLang)
						                                                 }}</span>
					</div>
					<div class="details" v-if="details === 2">
						<div class="detail-cont">
							...
							<div class="detail-row single">
								<p>
									<span>{{
											Translate('During this periode we expect a housing market development of', currentLang)
									      }}</span>
									<span class="green-highlight">{{ customRound(r25) }}</span>
									<span>{{ Translate('% increase p.a.', currentLang) }}</span>
									<span>{{
											Translate('So we expect your house to rise so much in value:', currentLang)
									      }}</span>
