	...
	<div class="mini-calculator">
		...
		<div class="results-wrapper">
			...
			<div class="result-row flex-end">
				<a @click="saveLocal()" class="link-to"
				   href="/woningwaarde-calculator">{{ Translate("detailed calculator", currentLang) }}
					<i>></i></a>
			</div>
		</div>
	</div>
