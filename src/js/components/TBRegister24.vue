	...
	<div class="stepped-form-handler" ref="body">
		<div class="steps-cont" :class="[{'tab-style':!intro}]">
			<div class="steps-header" v-show="!intro">
				...
				<h1>Inschrijving Thuisborg Woningwaarde Vastgoed Obligaties Serie TB24</h1>
			</div>
			<form action='https://forms.zohopublic.eu/soliditry/form/InschrijvingThuisborgWoningwaardeVastgoedObligatie6/formperma/FTyzOLITJ1F9vBbYqLdX1HeLMumojO0x9fLwJ3PULf0/htmlRecords/submit'
			      method='POST'
				...
				<div class="tabs-cont" :class="[{'intro':intro}]">
					...
					<div class="tab-body">
						<div class="step step-0 intro" v-show="currentStep.alias === 'intro'"
						     :class="[ {'active':currentStep.alias === 'intro'}]">
							<div class="intro">
								...
								<div class="intro-body">
									...
									<div class="intro-text">
										<p>Voor het registratieproces is het belangrijk dat u een kopie van uw
										   identiteitsbewijs
										   beschikbaar
										   hebt en dat alle informatie correct wordt ingevuld. Het registratieproces
										   duurt
										   ongeveer <b>5 minuten</b>. </p>
										<br>
										<p>Voordat u overgaat tot de betalingstransactie, krijgt u eerst het
										   ingevulde
										   overzicht van uw
										   aanvraag
										   te zien. Controleer nogmaals of alles in orde is.</p>
									</div>
									<div class="intro-agreement">
										<div class="agreement-item">
											<input type="checkbox" id="agreement" name="privacy">
											<label for="agreement">Ik ben akkoord met de <a href="https://thuisborg.nl/template/docs/av-thuisborg-v3.2-nl.pdf"> Algemene
											                                                         Voorwaarden</a>
											                       en
												<a
										...
										<div class="agreement-item">
											...
											<label for="instructies">Ik heb de instructies gelezen en ben klaar
											                         om
											                         verder te
											                         gaan</label>
										</div>
									...
									<span @click="changeStep('next')"
									      class="btn reg-btn" :class="[{'disabled' : !isStepValid}]">Begin met inschrijving</span>
									</div>
								</div>
								<div class="intro-footer">
									<img src="/template/images/schermafbeelding.png" class="afm"
									     alt="schermafbeelding">
									<img src="/template/images/Secure-payments.png" class="logos"
									     alt="Secure-payments">
								</div>
							</div>
						</div>
						<div class="step step-1" v-show="currentStep.alias === 'step1'"
						     :class="[ {'active':currentStep.alias === 'step1'}]">
							<div class="tab-wrapper">
								<p class="single-line-h2">Geïnteresseerde(n) wenst of wensen zich in te schrijven voor
								                          de
								                          volgende Obliigaties:</p>
								<p class="single-line-p bold">Thuisborg Woningwaarde Vastgoed Obligaties Serie TB24</p>
							...
							<div class="tab-footer">
								<span @click="changeStep('next')"
								      class="btn reg-btn" :class="[{'disabled' : !isStepValid}]">Volgende
								</span>
							</div>
						</div>
						<div class="step step-2" v-show="currentStep.alias === 'step2'"
						     :class="[ {'active':currentStep.alias === 'step2'}]">
							<div class="tab-wrapper">
								...
								<div v-show="organization" class="row">
									...
									<div class="input">
										<div class="multi-fields col-2">
											<div class="col">
												...
												<input type="text" maxlength="255" name="Address1_AddressLine1"
												       checktype="c1"
												       placeholder=""/>
											</div>
											<div class="col">
												...
												<input type="text" maxlength="255"
												       name="Address1_AddressLine2" checktype="c1"
												       placeholder=""/>
											</div>
											<div class="col">
												<div class="note">
												...
												<input type="text" maxlength="255"
												       name="Address1_City" checktype="c1"
												       placeholder=""/>
											</div>
											<div class="col">
												<div class="note">
									...
									<div class="note">
										<p>Waar van toepassing: Vertegenwoordiger verklaart op te
										   treden namens voornoemde rechtspersoon als Obligatiehouder
										   en voor deze inschrijving op Obligaties volledig bevoegd
										   te zijn om deze rechtspersoon te vertegenwoordigen.</p>
									</div>
								</div>
								<div class="multi-row">
									<div class="row required">
										...
										<div class="input">
											<div class="multi-fields col-3">
												...
												<div class="col">
													<div class="input">
														<input type="text" maxlength="255" name="Name_First"
														       placeholder="Voornaam"/>
													</div>
												</div>
												<div class="col">
													<div class="input">
														<input type="text" maxlength="255" name="Name_Last"
									...
									<div class="row required">
										...
										<div class="input">
											<div class="date-picker-container-icon">
												<custom-date-picker format="dd-MM-yyyy" simple name="Date1"
												                    :locale-config="localeConfig"
												                    @change="datesChangeListener"/>
									...
									<div class="row required">
										...
										<div class="input">
											<input type="text" maxlength="255"
											       name="Address_AddressLine1" checktype="c1"
											       placeholder=""/>
										</div>
									</div>
									<div class="row">
										...
										<div class="input">
											<div class="multi-fields col-2">
												...
												<div class="col input">
													...
													<input type="text" maxlength="255"
													       name="Address_ZipCode" checktype="c1"
													       placeholder=""/>
												</div>
												<div class="col input">
													<div class="note">
													...
													<input type="text" maxlength="255"
													       name="Address_City" checktype="c1"
													       placeholder=""/>
												</div>
												<div class="col input">
													<div class="note">
													...
													<select
															name="Address_Country" checktype="c1">
														<option value="">-Select-</option>
														<option>&Aring;land Islands</option>
														<option>Afghanistan</option>
														<option>Akrotiri</option>
												...
												<div class="col input">
													...
													<input type="text" name="PhoneNumber_countrycode" maxlength="20"
													       value=""/>
												</div>
												<div class="col input">
								...
								<div class="row">
									<div class="input">
										<div class="checkbox-set">
											<input type="checkbox" checktype="c1" id="DecisionBox1" v-model="secondary"
											       name="DecisionBox1"/>
											<label for="DecisionBox1">Ik wil een tweede Obligatiehouder toevoegen
											                          (optioneel)</label>
										</div>
									</div>
									<div class="note">
										<p>Waar van toepassing: Eerstgenoemde Obligatiehouder wordt door
										   de tweede Obligatiehouder aangewezen als contactpersoon en
										   gemachtigde voor alle Obligaties waarop ingeschreven
										   wordt.</p>
									</div>
								</div>
								<div v-show="secondary" class="row">
									...
									<div class="input">
										<div class="multi-fields">
											...
											<div class="col input">
												<input type="text" maxlength="255" name="Name1_First" fieldType=7
												       placeholder=""/>
												<div class="note"><p>Voornaam</p></div>
											</div>
											<div class="col input">
												<input type="text" maxlength="255" name="Name1_Last" fieldType=7
												       placeholder=""/>
												<div class="note">
													<p>Achternaam</p>
												</div>
								...
								<div v-show="secondary" class="row">
									...
									<div class="input">
										<div class="multi-fields col-2">
											<div class="col input">
												<div class="note">Staat en huisnummer</div>
												<input type="text" maxlength="255" name="Address2_Region" checktype="c1"
												       placeholder=""/>
											</div>
											<div class="col input">
												<div class="note">Postcode</div>
												<input type="text" maxlength="255"
												       name="Address2_ZipCode" checktype="c1"
												       placeholder=""/>
											</div>
											<div class="col input">
												<div class="note">
												...
												<input type="text" maxlength="255"
												       name="Address2_City" checktype="c1"
												       placeholder=""/>
											</div>
											<div class="col input">
												<div class="note">
												...
												<select class="zf-form-sBox"
												        name="Address2_Country" checktype="c1">
													<option value="">-Select-</option>
													<option>&Aring;land Islands</option>
													<option>Afghanistan</option>
													<option>Akrotiri</option>
											...
											<div class="col input">
												...
												<input type="text" maxlength="255"
												       name="Address2_AddressLine1" checktype="c1"
												       placeholder=""/>
											</div>
											<div class="col input">
												...
												<input type="text" compname="PhoneNumber1"
												       ...
												       maxlength="20" checktype="c7" value=""
											...
											<div class="col input">
												...
												<input fieldType=9 type="text" maxlength="255" name="Email1"
												       checktype="c5"
												       value="" placeholder=""/>
											</div>
										</div>
							...
							<div class="tab-footer">
								...
								<span @click="changeStep('previous')"
								      class="btn reg-btn">Terug</span>
							</div>
						</div>
						<div class="step step-3" v-show="currentStep.alias === 'step3'"
						     :class="[ {'active':currentStep.alias === 'step3'}]">
							<div class="tab-wrapper">
								<p class="single-line-p bold">Voor de ontvangst van enig voordeel of vergoeding of
								                              uitkering door, namens of vanwege Thuisborg in verband met
								                              deze effecten wijst Obligatiehouder de volgende
								                              bankrekening aan:
								</p>
								<div class="row">
									<div class="label">
									...
									<div class="input">
										<input type="text" maxlength="255" name="Address3_AddressLine1" checktype="c1"
										       placeholder=""/>
									</div>
								</div>
								<div class="row">
									...
									<div class="input">
										<input type="text" maxlength="255"
										       name="Address3_AddressLine2" checktype="c1"
										       placeholder=""/>
									</div>
								</div>
								<div class="row">
									...
									<div class="input">
										<input type="text" maxlength="255"
										       name="Address3_City" checktype="c1"
										       placeholder=""/>
									</div>
								</div>
								<div class="row checkbox-set">
									...
									<div class="note">
										<p>U kunt het rendement direct herinvesteren. Het exacte bedrag van uw
										   rendementsuitkering wordt
										   dan bijgestort in het lopende product dan wel in een opvolgende serie. Zo
										   blijft uw deelneming
										   exponentieel groeien.</p>
									</div>
								</div>
								<div class="row required">
									<div class="label">
									...
									<div class="note">
										...
										<p>Bestandstypes: JPEG, JPG, PNG, GIF, TIF, TIFF, WEBP, JFIF en
										   ICO. Max. 20MB.
										   De machinecode mag u afschermen.
										   U kunt uw ID veilig verzenden door het met de link toe te
										   voegen of door het bestand te verslepen naar het vak.</p>
									</div>
								</div>
						...
						<div class="step step-4" v-show="currentStep.alias === 'step4'"
						     :class="[ {'active':currentStep.alias === 'step4'}]">
							<div class="tab-wrapper">
								<h2 class="single-line-h2 bold">Belangrijke informatie</h2>
								<p class="single-line-p">Na ontvangst van het compleet ingevulde inschrijfformulier
								                         ontvangt u, na controle op volledigheid, een toewijzing van uw
								                         deelname onder opschortende voorwaarde van overmaking van het
								                         deelnamebedrag. Het deelnamebedrag dient binnen 10 werkdagen na
								                         ondertekening van het inschrijfformulier te zijn overgemaakt op
								                         de betaalrekening van Thuisborg Finance B.V. In geval dat het
								                         deelnamebedrag niet tijdig of volledig wordt ontvangen, is
								                         Thuisborg Finance B.V. bevoegd deze koopovereenkomst te
								                         ontbinden. In plaats van overboeking kan ook een bestaande
								                         vordering van Obligatiehouder op Thuisborg Finance B.V. worden
								                         geconverteerd of verrekenend binnen deze termijn, zoals bepaald
								...
								<br>
								<p class="single-line-p bold">Na ontvangst van het deelnamebedrag ontvangt u een
								                              bevestiging.</p>
								<br>
								<div class="seperator"></div>
								<br>
								<h2 class="single-line-h2 bold">Handtekening voor akkoord</h2>
								<p class="single-line-p">De aankoop van deze effecten valt onder de bepalingen van
								                         afdeling 3A van Titel 3 van Boek 6 Burgerlijk Wetboek en
								                         daarmee onder het toezicht van de Autoriteit Consument en Markt
								                         en de Autoriteit Financiële Markten op de naleving daarvan. De
								                         aanbieding van deze effecten valt niet onder de reikwijdte van
								                         de Wet op het financieel toezicht en daarmee ook niet onder het
								                         toezicht van de AFM op naleving daarvan.
								                         Met ondertekening verklaart ondergetekende dat alle gegevens
								                         naar waarheid werden ingevuld en dat deze voldoende bekend is
								                         met de meest recente informatie op de website, de brochure, de
								                         akte en met het meest recente informatiedocument van Thuisborg
								                         met betrekking tot deze effecten. Ondergetekende verklaart dat
								                         zij deze informatie schriftelijk dan wel per e-mail heeft
								                         ontvangen per de datum van ondertekening van dit
								                         Inschrijfformulier. Tevens verklaart hierna ondertekende
								                         Obligatiehouder – waar van toepassing namens de (rechts-)
								                         persoon die wordt vertegenwoordigd – dat zij de ontvangen
								                         informatie gelezen en begrepen heeft en dat zij daarmee
								                         volledig akkoord is gegaan voorafgaand aan navolgende
								                         ondertekening:
								</p>
								<div class="row">
									<div class="label">
									...
									<div class="input">
										<signature @change="fieldsChange($event)" name="Signature"
										           ref="Signature"></signature>
									</div>
									<div class="note">
										<p>of: de vertegenwoordigde
										   vennootschap </p>
									</div>
								</div>
								<div class="row" v-show="secondary">
									<div class="label">
										<label for="">Handtekening Tweede Obligatiehouder
										</label>
									</div>
									<div class="input">
						...
						<div class="step step-4" v-show="currentStep.alias === 'step5'"
						     :class="[ {'active':currentStep.alias === 'step5'}]">
							<div class="tab-wrapper">
							...
							<div class="tab-footer">
								<span style="visibility: hidden" @click="formSubmit" v-show="!zohoSuccess"
								      class="btn reg-btn" :class="[{'disabled' : !isStepValid}]">Volgende
								</span>
								<span @click="changeStep('previous')" v-show="!zohoSuccess"
								      class="btn reg-btn">Terug</span>
							</div>
						</div>
				...
				if (!!item.condition) {
					...
					item.condition.nodes.forEach((nodeItemInNodes, index) => {
						if (nodeItemInNodes.type === 'radio' || nodeItemInNodes.type === 'checkbox') {
							finalValueInsideCondition = !!finalValueInsideCondition ? (!!nodeItemInNodes.checked ? nodeItemInNodes.checked : finalValueInsideCondition) : nodeItemInNodes.checked;
						} else {
