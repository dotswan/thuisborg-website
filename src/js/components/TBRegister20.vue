	...
	<div class="stepped-form-handler" ref="body">
		<div class="steps-cont" :class="[{'tab-style':!intro}]">
			<div class="steps-header" v-show="!intro">
				...
				<h1>Inschrijving Thuisborg Woningwaarde Vastgoed Obligaties Serie TB20</h1>
			</div>
					...
					<div class="tab-body">
						...
						<div class="step step-1" v-show="currentStep.alias === 'step1'"
							...
							<div class="tab-wrapper">
								...
								<p class="single-line-p bold">Thuisborg Woningwaarde Vastgoed Obligaties Serie TB20</p>
									...
									<div class="input">
										<div class="date-picker-container-icon">
											<custom-date-picker format="dd-MM-yyyy" simple name="Date2"
											                    :locale-config="localeConfig" @change="fieldsChange"/>
