<template>
  <div class="stepped-form-handler" ref="body">
    <div class="steps-cont" :class="[{ 'tab-style': !intro }]">
      ...
      <form
        action="https://forms.zohopublic.eu/soliditry/form/InschrijvingThuisborgWoningwaardeVastgoedObligatie5/formperma/0LzuimR9FxfeuEXQs80LCp8YNtQNjsTxL3lzMCVHMlY/htmlRecords/submit"
        method="POST"
            ...
            <div class="step step-1" v-show="currentStep.alias === 'step1'" :class="[{ active: currentStep.alias === 'step1' }]">
              <div class="tab-wrapper">
                ...
                <div class="row" v-show="!!emissionpercentage">
                  ...
                  <div class="note" v-if="!!discountCode && discountCode !== 'ThuisborgFinance'">
              ...
              <div class="tab-wrapper">
                ...
                <div class="multi-row">
                  ...
                  <div class="row required">
                    ...
                    <div class="input">
                      <div class="date-picker-container-icon">
                        <custom-date-picker format="dd-MM-yyyy" simple name="Date1" :locale-config="localeConfig" @change="fieldsChange" />
                ...
                <div v-show="secondary" class="row">
                  ...
                  <div class="input">
                    <div class="date-picker-container-icon">
                      <custom-date-picker format="dd-MM-yyyy" simple name="Date2" :locale-config="localeConfig" @change="fieldsChange" />
