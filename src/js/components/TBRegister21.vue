	...
	<div class="stepped-form-handler" ref="body">
		<div class="steps-cont" :class="[{'tab-style':!intro}]">
			<div class="steps-header" v-show="!intro">
				...
				<h1>Inschrijving Thuisborg Woningwaarde Vastgoed Obligaties Serie TB21</h1>
			</div>
			<form action='https://forms.zohopublic.eu/soliditry/form/InschrijvingThuisborgWoningwaardeVastgoedObligatie8/formperma/dj65iVaQJKswvAQpVJQMKjvXOIwbfeLjCn3MV3TfWp8/htmlRecords/submit'
			      method='POST'
					...
					<div class="tab-body">
						...
						<div class="step step-1" v-show="currentStep.alias === 'step1'"
							...
							<div class="tab-wrapper">
								...
								<p class="single-line-p bold">Thuisborg Woningwaarde Vastgoed Obligaties Serie TB21</p>
