	...
	<div class="stepped-form-handler" ref="body">
		<div class="steps-cont" :class="[{'tab-style':!intro}]">
			<div class="steps-header" v-show="!intro">
				...
				<h1>Inschrijving Thuisborg Woningwaarde Vastgoed Obligaties Serie TB19</h1>
			</div>
					...
					<div class="tab-body">
						...
						<div class="step step-1" v-show="currentStep.alias === 'step1'"
							...
							<div class="tab-wrapper">
								...
								<p class="single-line-p bold">Thuisborg Woningwaarde Vastgoed Obligaties Serie TB19</p>
								<div class="row required">
									...
									<div class="input">
										<div class="date-picker-container-icon">
											<datepicker name="Date" format="dd-MM-yyyy" :value="Date.now()"></datepicker>
											<div class="icon-cont">
								...
								<div class="row">
									<div class="label">
										<label>Emissiekosten 2%</label>
									</div>
									<div class="input">
										<input type="text" name="Emissiekosten">
									</div>
									<div class="note">
								...
								<div class="row">
									...
									<div class="input">
										<input type="text" name="totalbedrag">
									</div>
									<div class="note">
								...
								<div class="row required">
									<div class="label">
										<label>Looptijd (vanaf 3/5 jaar)</label>
									</div>
									<div class="input">
										<div class="checkbox-group">
											<div class="checkbox-set">
												<input type="checkbox" name="checkbox" value="1 jaar" id="Looptijd-1">
												<label for="Looptijd-1">1 jaar</label>
											</div>
											<div class="checkbox-set">
												<input type="checkbox" name="checkbox" value="3 jaar" id="Looptijd-3">
												<label for="Looptijd-3">3 jaar</label>
											</div>
											<div class="checkbox-set">
												<input type="checkbox" name="checkbox" value="5 jaar" id="Looptijd-5">
						...
						<div class="step step-2" v-show="currentStep.alias === 'step2'"
							...
							<div class="tab-wrapper">
								<p class="single-line-h2">Contact gegevens obligatiehouder</p>
								<div class="row">
									<div class="input">
								...
								<div class="row">
									<div class="input">
										<div class="checkbox-set">
											<input type="checkbox" checktype="c1" id="DecisionBox1"
											       name="DecisionBox1"/>
								...
								<div class="row">
									...
									<div class="input">
										<input name="Date2" checktype="c4" value="" maxlength="25"
						...
						<div class="step step-3" v-show="currentStep.alias === 'step3'"
							...
							<div class="tab-wrapper">
								...
								<div class="row">
									...
									<div class="note">
										<p>U kunt het rendement direct herinvesteren. Het exacte bedrag
										   van uw rendementsuitkering wordt dan bijgestort in het lopende
										   product. Zo blijft uw deelneming exponentieel groeien.</p>
									</div>
								</div>
								<div class="row required">
									<div class="label">
						...
						<div class="step step-4" v-show="currentStep.alias === 'step5'"
							...
							<div class="tab-wrapper">
								...
								<div class="other-payment-method" :class="[{'enabled' : !canPay}]">
									<div class="other-payment-cont">
										...
										<h2 class="single-line-h2 bold navy">Lorem ipsum dolor sit amet, consectetur
										                                     adipiscing elit.</h2>
							...
							<div class="tab-footer">
								<span @click="formSubmit" v-show="!zohoSuccess"
								      class="btn reg-btn" :class="[{'disabled' : !isStepValid}]">Volgende
								</span>
