<template>
  <div class="register-form" ref="body">
    ...
    <form
      action="https://forms.zohopublic.eu/soliditry/form/TBwebsiteBekijkuwmogelijkheden/formperma/w6wMmzSHmLmWQUpqQLIQS3eUgwpZ2Ix8ahaxbCtleo4/htmlRecords/submit"
      name="form"
      method="POST"
      ref="form"
      ...
      id="form"
      @submit.prevent.stop="next($event)"
    >
      ...
      <div class="step-cont" v-show="!thankYou && step == 1">
        ...
        <p>Laten we kijken naar uw mogelijkheden. Wij hebben uw adres nodig om in te kunnen schatten of uw woning in aanmerking komt.</p>
        <div class="field-row">
          <input type="text" name="SingleLine2" checktype="c1" value="" maxlength="255" fieldType="1" v-model="q" placeholder="Straat & huisnummer" />
        </div>
        <div class="field-row">
          <input type="text" name="SingleLine3" checktype="c1" value="" maxlength="255" fieldType="1" placeholder="Postcode" />
        </div>
        <div class="field-row">
          <input type="text" name="SingleLine4" checktype="c1" value="" maxlength="255" fieldType="1" placeholder="Stad" />
        </div>
      ...
      <div class="step-cont" v-show="!thankYou && step == 2">
        ...
        <div class="inpt-set">
          ...
          <div class="field-row">
            <input type="text" name="Number" checktype="c1" value="" maxlength="255" fieldType="1" placeholder="" />
          </div>
        </div>
        <div class="inpt-set">
        ...
        <div class="inpt-set">
          ...
          <div class="field-row">
            <input type="number" name="Number1" checktype="c1" value="" maxlength="255" fieldType="1" placeholder="(Graag alleen een nummer invullen)" />
          </div>
        </div>
        <button class="btn">Verder gaan</button>
      </div>
      <div class="step-cont" v-show="!thankYou && step == 3">
        ...
        <div class="inpt-set">
          ...
          <div class="field-row">
            <select name="SingleLine8" checktype="c1" maxlength="255" fieldType="1">
        ...
        <div class="inpt-set">
          ...
          <div class="field-row">
            <input type="text" name="Number2" checktype="c1" value="" maxlength="255" fieldType="1" placeholder="" />
          </div>
        </div>
        <button class="btn">Verder gaan</button>
      </div>
      <div class="step-cont" v-show="!thankYou && step == 4">
        ...
        <!--					<p>Lorem ipsum dolor sit amet, consectetscing elit</p>-->
        <div class="field-row">
          <input type="text" name="SingleLine" checktype="c1" value="" maxlength="255" fieldType="1" placeholder="Voornaam" />
        </div>
        <div class="field-row">
          <input type="text" name="SingleLine1" checktype="c1" value="" maxlength="255" fieldType="1" placeholder="Achternaam" />
        </div>
        <div class="field-row">
          <input fieldType="9" type="text" maxlength="255" name="Email" checktype="c5" value="" placeholder="E-mailadres" />
        </div>
        <div class="field-row">
          <input type="text" name="SingleLine10" checktype="c1" value="" maxlength="255" fieldType="1" placeholder="Telefoonnummer" />
        </div>
        <!--				<div class="code-num">-->
        ...
        <div class="agreement">
          ...
          <label for="DecisionBox">Ik accepteer de <a href="https://thuisborg.nl/docs/2.-AV-Thuisborg-2021-v3-NL.pdf">voorwaarden</a> van Thuisborg</label>
        </div>
        <button class="btn">Verder gaan</button>
      </div>
