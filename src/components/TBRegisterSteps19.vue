        ...
        <div class="tabs-cont" :class="[{ intro: intro }]">
          ...
          <div class="tab-body">
            ...
            <div class="step step-1" v-show="currentStep.alias === 'step1'" :class="[{ active: currentStep.alias === 'step1' }]">
              <div class="tab-wrapper">
                ...
                <div class="row required">
                  ...
                  <div class="note">
                    <p>Nominale waarde per Obligatie € 0,01. Minimaal deelnamebedrag van € 1.000,-</p>
                  </div>
                </div>
                <div class="row">
                  <div class="label">
                  ...
                  <div class="note">
                    <p>
                      Vast rendement wordt dan basis rendement, daar komt bovenop: de variabele rendementsvergoeding, gebaseerd op de prijsontwikkeling van de
                      Nederlandse huizenmarkt, met een bandbreedte tussen -3% en 3%
                    </p>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row required">
                  ...
                  <div class="input">
                    <div class="radio-group">
                      <div class="radio-set">
                        <input type="radio" id="Keuze-ja" name="Radio" value="Ja" />
                        <label for="Keuze-ja">Ja</label>
                      </div>
                      <div class="radio-set">
                        <input type="radio" id="Keuze-Nee" name="Radio" value="Nee" />
            ...
            <div class="step step-2" v-show="currentStep.alias === 'step2'" :class="[{ active: currentStep.alias === 'step2' }]">
              <div class="tab-wrapper">
                ...
                <div class="row">
                  ...
                  <div class="input">
                    <input name="Date2" checktype="c4" value="" maxlength="25" placeholder="" type="date" />
                    <div class="note">
                      <p>dd-MM-yyyy</p>
                    </div>
                  </div>
            ...
            <div class="step step-3" v-show="currentStep.alias === 'step3'" :class="[{ active: currentStep.alias === 'step3' }]">
              <div class="tab-wrapper">
                ...
                <div class="row">
                  ...
                  <div class="note">
                    <p>
                      U kunt het rendement direct herinvesteren. Het exacte bedrag van uw rendementsuitkering wordt dan bijgestort in het lopende product. Zo
                      blijft uw deelneming exponentieel groeien.
                    </p>
                  </div>
                </div>
                <div class="row required">
            ...
            <div class="step step-4" v-show="currentStep.alias === 'step5'" :class="[{ active: currentStep.alias === 'step5' }]">
              <div class="tab-wrapper">
                ...
                <div class="other-payment-method" :class="[{ enabled: !canPay }]">
                  <div class="other-payment-cont">
                    ...
                    <h2 class="single-line-h2 bold navy">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h2>
                    <p>
              ...
              <div class="tab-footer">
                <span @click="formSubmit" v-show="!zohoSuccess" class="btn reg-btn" :class="[{ disabled: !isStepValid }]">Volgende </span>
