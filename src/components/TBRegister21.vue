<template>
  <div class="stepped-form-handler" ref="body">
    <div class="steps-cont" :class="[{ 'tab-style': !intro }]">
      ...
      <form
        action="https://forms.zohopublic.eu/soliditry/form/InschrijvingThuisborgWoningwaardeVastgoedObligatie8/formperma/dj65iVaQJKswvAQpVJQMKjvXOIwbfeLjCn3MV3TfWp8/htmlRecords/submit"
        method="POST"
